...
for(var i=0; i<cards.length; i++) {  
    var gridItem = AddGridItem(cards[i].imgUrl, cards[i].imgAlt, cards[i].header, cards[i].description); 
    grid.appendChild(gridItem); 
}

function AddGridItem(imgUrl, imgAlt, header, description) {
    // Creating elts for gridItem
